...
const Home: NextPage = () => {
  return (
    <>
      <Container className="px-6 leading-relaxed py-16 md:py-20">
        <main>
          <h1 className="font-medium">Hannes Bornö</h1>
          <p className="text-gray-400 mt-6">
            Frontend developer from Sweden. Building stuff for the web. Into
            TypeScript, Next.js and Tailwind.
          </p>
          <h2 className="mt-12 md:mt-16 font-medium">Contact</h2>
          <div className="text-gray-400 mt-6 flex">
          ...
          <h2 className="mt-12 md:mt-16 font-medium">Projects</h2>
          <div className="gap-5 md:gap-8 mt-8 grid grid-cols-1 md:grid-cols-2 justify-items-stretch">
            <Project
            ...
            >
              Ever wanted to try something like Next.js, but worse? Well, then
              you{"'"}re in luck!
            </Project>
            <Project
